...
class CreateModel_pascal(nn.Module):
    def __init__(self):
        super(CreateModel_pascal, self).__init__()
        ...
        self.layer12 = nn.Conv2d(256,102,1,1,0)
        # self.layer13 = nn.Conv2d(54,256+128,1,1,0)
        self.layer13 = nn.Conv2d(102,256+128,1,1,0)
        ...
        self.layer17 = lin(512,256)
        # self.layer18 = nn.Conv2d(512,54,1,1,0)
        self.layer18 = nn.Conv2d(512,102,1,1,0)
